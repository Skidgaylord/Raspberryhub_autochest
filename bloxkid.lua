...
Converted["_RaspberryLogo"].Image = "rbxassetid://16131678880"
Converted["_RaspberryLogo"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_RaspberryLogo"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_RaspberryLogo"].BorderSizePixel = 0
Converted["_RaspberryLogo"].Position = UDim2.new(0.0337078646, 0, 0.107784428, 0)
Converted["_RaspberryLogo"].Size = UDim2.new(0, 90, 0, 90)
Converted["_RaspberryLogo"].Name = "RaspberryHub"
Converted["_RaspberryLogo"].Parent = Converted["_Frame1"]

Converted["_UICorner1"].Parent = Converted["_RaspberryHub"]
    ...
    function thisCode()
        ...
        function AllowRunServiceBind.OnInvoke(args)
            ...
            CoreGui:SetCore("SendNotification", {
                Title = "Raspberry Hub",
                Text = "Raspberry Hub Auto Chest Beta Version is best Script!!!",
                Duration = math.huge,
